...
async def etl_memes_from_raw_telegram_posts() -> None:
    ...
    # find rows which already exist in db by two index columns: meme_source_id and raw_meme_id
    ...
    print("memes_not_in_memes_table", memes_not_in_memes_table)
    print("create_these_memes", create_these_memes)
    ...
    print(
        f"Going to insert {len(create_these_memes)} new memes. And update {len(update_these_memes)}."
    )
