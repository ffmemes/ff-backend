...
ALLOWLIST=':!scripts/redaction_audit.py :!scripts/pre-commit-secrets-check.sh :!scripts/run_paperclip_ralphex.sh :!tests/test_redaction_audit.py :!docs/public-repo-rule.md'
