...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['language_code'], ['language.code'], name=op.f('user_language_language_code_fkey'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('user_language_user_id_fkey'), ondelete='CASCADE'),
