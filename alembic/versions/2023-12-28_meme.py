...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['duplicate_of'], ['meme.id'], name=op.f('meme_duplicate_of_fkey'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['language_code'], ['language.code'], name=op.f('meme_language_code_fkey'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['meme_source_id'], ['meme_source.id'], name=op.f('meme_meme_source_id_fkey'), ondelete='CASCADE'),
