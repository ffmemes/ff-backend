...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["meme_source_id"],
            ["meme_source.id"],
            name=op.f("user_meme_source_stats_meme_source_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["user.id"],
            name=op.f("user_meme_source_stats_user_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "meme_source_id", name=op.f("user_meme_source_stats_pkey")
        ),
    )
